...
class inicio : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        bienvenida.text = "Hola ${usuario?.username ?: "usuario desconocido"}"
        ...
        val taskList = listOf(
            ...
            Task("Lavar los trastes", "Descripción de lavar los trastes"),
            Task("Sacar la basura", "Descripción de sacar la basura")
        )
